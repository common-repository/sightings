...
function sightings_map_function($parameters) {
    ...
    if(isset($_POST['sightings_date']) && $_POST['sightings_date'] != '') {
        $sightings_post_array['date'] = $_POST['sightings_date'];
    }
    ...
    if(isset($_POST['marker_lat']) && $_POST['marker_lat'] != '' && isset($_POST['marker_lng']) && $_POST['marker_lng'] != '') {
        $sightings_post_array['markers'] = array(array($_POST['marker_lat'], $_POST['marker_lng']));
    }
    ...
    <div id="sightings_message">
        ...
        if(empty($sightings_post_array['title']) || empty($sightings_post_array['body']) || empty($sightings_post_array['markers']) || empty($sightings_post_array['zoom'])) {
        echo '<p class="error">';
    ...
    jQuery(document).ready(function(){
        ...
        if(count($sightings) > 0) {
            ...
            jQuery('.sightings_contributor_panel a').one('click', function() {
                ...
                $sight_form .='<div><label>'.__('Date', SIGHTINGS_HANDLE).':<input type="text" id="sightings_date" name="sightings_date" style="width:20%" /></label></div>';
                ...
                google.maps.event.addListener(marker, 'click', function(){
                    ...
                    var updateSightForm = function () {
                        ...
                        jQuery('#sightings_date').datepicker();
                    };
