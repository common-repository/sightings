...
View the post, the map should now be displayed at the top of your post.
...
= 1.3.2.3 =
* Bug fix for contributed sightings. Locations were not stored correctly and caused sightings-map to not render at all. You may need to delete old sightings if you experience problems since contributor locations may be corrupted.
* Date picker in contributor sightings.

= 1.3.2.2 =
* Bug fix for latitudes and longitudes not being retrieved in a suggested way. This could cause, under some cirumstances, markers to be placed in "Limbo" (i.e. on positions outside the map that does not really exist).
...
* Removed lingering lambda function that caused problems for users with strict or old PHP installations (Thanks to photosite.de and remtheory for bug reporting).
...
= 1.3.2.3 =
* Bug fix for contributed sightings. Locations were stored wrong which caused sightings-map to not render at all.
* Date picker in contributor sightings.

= 1.3.2.2 =
* Bug fix for latitudes and longitudes not being retrieved in a suggested way. This could cause markers to be placed in "Limbo".
